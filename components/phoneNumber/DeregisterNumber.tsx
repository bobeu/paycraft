...
import { validatePhoneNumber } from "./twilioService";

export default function DeregisterNumberModal({ isOpen, onDismiss, deregisterNumber,}: { isOpen: boolean; onDismiss: () => void; deregisterNumber: (number: string) => Promise<void>;}) {
